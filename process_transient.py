class Process_Transient:
    ...
    def __init__(self, pid, arrival_time, burst_time, priority=15):
        ...
        self.priority = priority if priority is not None else 15  # Assign a default priority if not specified
